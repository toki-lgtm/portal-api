...
// 稼働中の有効キー（WorkScope）を優先。次に .env、最後に旧SNSキー。
const GEMINI_KEY = readKeyFile('C:/ProgramData/WorkScope/GEMINI_API_KEY.txt') || process.env.GEMINI_API_KEY || readKeyFile('../../02.SNS/GEMINI_API_KEY.txt');
